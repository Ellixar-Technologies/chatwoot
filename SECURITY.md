Ellixar Chat is looking forward to working with security researchers worldwide to keep Ellixar Chat and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against Ellixar Chat production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping Ellixar Chat and our users safe. 🙇
